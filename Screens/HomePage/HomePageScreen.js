...
import { Modal, Image, KeyboardAvoidingView, Dimensions, TouchableOpacity, StyleSheet, View, Text, TextInput, SafeAreaView } from 'react-native';
...
const apiUrl = "https://us-central1-nominate-hr.cloudfunctions.net/api";

const loggedInUser = "9fghXhri1NNdKXNCuOWnGpuadQf2"
...
export default class HomePage extends Component {
  ...
  getEvents() {
    fetch(`${apiUrl}/users/${firebase.auth().currentUser.uid}`)
      .then(res =>{ 
        return res.json()
      })
      .then(({ events, users }) => {
          ...
          <View style={styles.events}>
            ...
            {!this.state.events ?
              ...
              : this.state.events.length ?
                <EventList navigation={this.navToEvent} getState={this.getState} events={this.state.events} />
